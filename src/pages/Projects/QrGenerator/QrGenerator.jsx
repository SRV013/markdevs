        ...
        <Page>
            <div className={styles.wrapper}>
                <div className={styles.header}>
                    <h1 className={styles.title}>Generador de <span className={styles.accent}>Códigos QR</span></h1>
                    <p className={styles.subtitle}>Crea códigos QR personalizados al instante. URL, texto o mensajes de WhatsApp.</p>
                </div>
